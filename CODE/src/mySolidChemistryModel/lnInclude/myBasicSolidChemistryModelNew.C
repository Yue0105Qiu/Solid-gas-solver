...
Foam::autoPtr<Foam::myBasicSolidChemistryModel>
Foam::myBasicSolidChemistryModel::veryNew(solidReactionThermo& thermo)
{
	Info<< "@MOR reading solidChemDictionary " 
		<< thermo.phasePropertyName("chemistryProperties")<< endl;
    ...
    Info<< "@MOR reading solidThermo again " 
		<< thermo.phasePropertyName("thermophysicalProperties")<< endl;
	...
	Info<< "@Mor end of veryNew() "  << endl;
	
    return
        autoPtr<myBasicSolidChemistryModel>(cstrIter()(thermo));
}
